            ...
            <div>
              ...
              <div className="text-gray-600 leading-relaxed space-y-4">
                ...
                <p>
                  ...
                  individuals who thought they were “ordinary contributors”
                  often discover they can influence far more than they ever
                  imagined.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed text-base">
                ...
                and courage sparks excellence in everyone. There are moments
                here, during a tough cyber incident, a new product sprint, or a
                customer escalation, where you see these values in action.
                Someone steps up. Someone shares openly. Someone challenges an
                established idea.
                <br />
                <br />
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="flex items-center">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed text-base">
                  Together, we foster a workplace where differences are
                  welcomed, perspectives are respected, and every person can
                  reach their full potential. Our aim is steady and clear:
                  create a space where opportunities flow to talent fairly,
                  where potential is noticed early, and where everyone has room
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="columns-1 sm:columns-2 lg:columns-4 gap-8">
            {Array.from({ length: 8 }).map((_, i) => (
              <div
                key={i}
                className="mb-8 break-inside-avoid rounded-2xl overflow-hidden"
              >
                <img
                  src="/assets/images/join-us/glam.png"
