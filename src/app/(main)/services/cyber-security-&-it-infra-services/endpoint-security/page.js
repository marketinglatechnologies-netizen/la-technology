...
export const metadata = {
  title: "Endpoint Security Services | LA Technologies Pvt Ltd",
  description:
    "Protect endpoints from advanced cyber threats with enterprise-grade endpoint security solutions",
};
