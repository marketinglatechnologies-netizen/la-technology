...
export const metadata = {
  title: "Network Security Solutions | LA Technologies Pvt Ltd",
  description:
    "Secure enterprise networks with advanced firewall, threat prevention, and network security solutions",
};
    ...
    <>
      <div>
        <InnerPageBanner
          ...
          titleTag="h1"
          description={`Defend the network that powers your business.`}
        />
      </div>
      ...
      <FiveCards
        ...
        items={[
          ...
          },
          {
            ...
            description: "Protect against phishing, spam, and malicious URLs.",
          },
        ]}
      />
      <WhyChooseSection
        ...
        {/* <div className="max-w-7xl mx-auto px-6"> */}
          ...
          {/* <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6"> */}
            ...
            {/* <div className="border border-gray-200 rounded-xl p-4 shadow-sm"> */}
              ...
              <p className="text-sm font-semibold">Fortinet</p>
            </div> */}
            ...
            {/* <div className="border border-gray-200 rounded-xl p-4 shadow-sm">
              ...
              <p className="text-sm font-semibold">Palo Alto Networks</p>
            </div> */}
            ...
            {/* <div className="border border-gray-200 rounded-xl p-4 shadow-sm">
              ...
              <p className="text-sm font-semibold">Sophos</p>
            </div>
          </div>
        </div> */}
      {/* </section> */}
