...
//                 In a rapidly changing digital landscape, having a trusted source
//                 of information is crucial. We curate content specifically for IT
...
//                   <div className="w-12 h-12 rounded-full bg-[#FFE6D4] flex items-center justify-center font-semibold text-orange-600">
//                     01
//                   </div>
//                   <div>
...
//                       Curated specifically for IT leaders, tech enthusiasts, and
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogs.map((blog) => (
              <div
                key={blog._id}
                href={`/insights/blogs/${blog.slug.current}`}
                className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg transition overflow-hidden"
              >
                <div className="h-[180px] w-full overflow-hidden">
