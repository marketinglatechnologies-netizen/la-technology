          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
              ...
              <div className="mt-10 lg:mt-0 lg:pl-12 space-y-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  With decades of expertise and a passion for innovation, we
                  deliver cutting-edge services that protect your most valuable
                  assets.
                </p>
                ...
                <Link
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, #DC2A3C 0%, #F58028 100%)",
                  }}
                >
                  Talk to an Expert
                </Link>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed text-sm md:text-base space-y-4">
                  <span className="block mb-4">
                    At LA Technologies, we are more than a cybersecurity firm;
                    we are your strategic partners in digital resilience.
                    Founded in 2003, we have spent over two decades empowering
                    enterprises to navigate complexity, mitigate risk, and
                    unlock growth through secure, scalable, and intelligent
                    solutions.
                  </span>

                  <span className="block mb-4">
                    Our approach combines deep technical expertise with
                    strategic foresight, delivering integrated cybersecurity
                    frameworks that align with business objectives and
                    regulatory landscapes. Our unwavering focus on execution
                    ensures precision, resilience, and long-term value.
                  </span>

                  <span className="block">
                    With a strong presence across key markets and a global
                    ecosystem of partners, we help organizations protect what
                    matters most. Whether you are a fast-scaling disruptor or a
                    Fortune 500 enterprise, LA Technologies is your trusted ally
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-600 leading-relaxed max-w-lg">
                  We believe in opening doors to infinite possibilities by
                  leveraging the power of technology to empower enterprises. Our
                  focus is on driving growth, enabling agility, and supporting
                  businesses with solutions that are future-ready and resilient.
                </p>
              </div>
          ...
          <PageWrapper>
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6">
              ...
              <div className="space-y-4 order-1 lg:order-2">
                ...
                <p className="text-gray-600 leading-relaxed max-w-lg">
                  Our vision is to provide our customers with the most
                  compelling IT and cybersecurity solutions in the
                  industry—solutions that not only protect but also enable
          ...
          <PageWrapper>
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-600 leading-relaxed max-w-lg">
                  To inspire stronger relationships with our clients by
                  connecting modern technologies to real-world challenges. We
                  aim to deliver secure, scalable, and intelligent solutions
                  that help businesses thrive in a digital-first economy.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-600 leading-relaxed max-w-lg">
                  ...
                  deliver world-class cybersecurity solutions. Our alliances
                  ensure that our clients benefit from the latest advancements
                  in network security, OT security, cloud security, and managed
                  services.
                </p>
              </div>
            </div>
        ...
        <section className="py-20 bg-[#faf8f5]">
          <div className="max-w-6xl mx-auto px-6 text-center">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto leading-relaxed mb-12">
              Partner with LA Technologies to build a security-first foundation
              for your enterprise. Our experts deliver tailored cybersecurity
              solutions that help you stay ahead of threats, ensure compliance,
