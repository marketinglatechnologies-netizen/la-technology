        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-gray-600 text-base leading-relaxed">
              ...
              and government organizations. With strong partnerships across 600+
              ISP operators (A/B/C class), we deliver managed broadband and
              Internet Lease Line (ILL) solutions to Tier 1–5 locations with
              uniform rate contracts, NOC support, and consolidated billing.
            </p>
